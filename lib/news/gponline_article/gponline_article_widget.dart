...
import 'gponline_article_model.dart';
export 'gponline_article_model.dart';

class GponlineArticleWidget extends StatefulWidget {
  const GponlineArticleWidget({
    super.key,
    this.title,
    this.url,
    this.description,
  ...
  @override
  State<GponlineArticleWidget> createState() => _GponlineArticleWidgetState();
}

class _GponlineArticleWidgetState extends State<GponlineArticleWidget> {
  late GponlineArticleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GponlineArticleModel());
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/GP_logo_(1)_copy.png',
                          width: 65.0,
                                    ...
                                    child: MouseRegion(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'GPONLINE_ARTICLE_Text_lpstgml3_ON_TAP');
                                            logFirebaseEvent(
                                                'Text_launch_u_r_l');
