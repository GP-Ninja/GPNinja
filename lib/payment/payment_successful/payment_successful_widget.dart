...
class _PaymentSuccessfulWidgetState extends State<PaymentSuccessfulWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'payment_successful'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PAYMENT_SUCCESSFUL_payment_successful_ON');
      logFirebaseEvent('payment_successful_backend_call');
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'PAYMENT_SUCCESSFUL_GET_STARTED_BTN_ON_TA');
