...
class _SubscriptionPageWidgetState extends State<SubscriptionPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'subscription_page'});
              ...
              children: [
                ...
                if (responsiveVisibility(
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Please sign-in on desktop to use GP Ninja',
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'For the full experience, why not give GP Ninja Premium a try?',
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'SUBSCRIPTION_GO_TO_CONSULT_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_navigate_to');
                                  ...
                                  children: [
                                              ...
                                              Padding(
                                                ...
                                                child: AuthUserStreamWidget(
                                                  builder: (context) =>
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'SUBSCRIPTION_START_14_DAY_FREE_TRIAL_BTN');
                                                      if (valueOrDefault(
                                                                  currentUserDocument
                                                                      ?.stripeCustId,
                                                                  '') ==
                                                        ...
                                                        logFirebaseEvent(
                                                            'Button_backend_call');
                                                        _model.createCustomerResponseOnPay =
                                                        ...
                                                        if ((_model
                                                          ...
                                                          ScaffoldMessenger.of(
                                                            ...
                                                            SnackBar(
                                                              content: Text(
                                                                'Something went wrong, please emai support@gpninja.co.uk and we will be able to assist you!',
                                                                style:
                                                                    TextStyle(
                                                                  color: FlutterFlowTheme.of(
                                                                          context)
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 14.0, 0.0, 0.0),
                                      child: Text(
                                        'Try Premium risk-free with a 2-week free trial.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                              fontFamily:
