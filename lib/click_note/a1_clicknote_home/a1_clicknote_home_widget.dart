    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: StreamBuilder<List<FlattenedTemplatesRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<FlattenedTemplatesRecord>
                      containerFlattenedTemplatesRecordList = snapshot.data!;
                                                  ...
                                                  child: Builder(
                                                    builder: (context) {
                                                      ...
                                                      return ListView.separated(
                                                        ...
                                                        itemBuilder: (context,
                                                            myTemplates1Index) {
                                                          final myTemplates1Item =
                                                              myTemplates1[
                                                                  myTemplates1Index];
                                                          return A3ClicknoteBlockSmallWidget(
                                                            key: Key(
                                                                'Key3zw_${myTemplates1Index}_of_${myTemplates1.length}'),
                                                            image:
                                                                myTemplates1Item
                                                                    .templateIcon,
                                                            title:
                                                            ...
                                                            child:
                                                              ...
                                                              onFieldSubmitted:
                                                                ...
                                                                if (((valueOrDefault(currentUserDocument?.stripeSubscriptionStatus, '') ==
                                                                                '') &&
                                                                        (valueOrDefault<bool>(currentUserDocument?.activeMembership, false) ==
                                                                            false)) ||
                                                      ...
                                                      builder: (context) {
                                                        ...
                                                        return ListView
                                                          ...
                                                          itemBuilder: (context,
                                                            ...
                                                            return A3ClicknoteBlockSmallWidget(
                                                              key: Key(
                                                                  'Keyd22_${comunityIndex}_of_${comunity.length}'),
                                                              image: comunityItem
                                                                  .templateIcon,
                                                              title: comunityItem
                                                                  .templateName,
