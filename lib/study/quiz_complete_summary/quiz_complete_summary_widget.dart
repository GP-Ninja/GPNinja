...
class QuizCompleteSummaryWidget extends StatefulWidget {
  ...
  @override
  State<QuizCompleteSummaryWidget> createState() =>
...
class _QuizCompleteSummaryWidgetState extends State<QuizCompleteSummaryWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'quiz_complete_summary'});
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(32.0, 12.0, 32.0, 12.0),
                    child: Text(
                      'Thanks for taking the quiz. Check your score below',
                              ...
                              Padding(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: 'Out of a possible ',
                                        style: TextStyle(),
                                      ),
                                      TextSpan(
                                        text: widget.quizRef!.totalPoints
                                            .toString(),
                                        style: TextStyle(),
                                      )
                                    ],
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'QUIZ_COMPLETE_SUMMARY_GO_HOME_BTN_ON_TAP');
