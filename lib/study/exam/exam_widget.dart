...
class _ExamWidgetState extends State<ExamWidget> {
  ...
  void initState() {
    ...
    _model.textController ??=
        TextEditingController(text: functions.newLine(widget.templateText!));
      ...
      child: Stack(
        children: [
          Row(
            ...
            children: [
              Align(
                alignment: AlignmentDirectional(-0.89, -2.0),
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('EXAM_COMP_CARDIAC_BTN_ON_TAP');
                    if (_model.showTemplate == true) {
                      logFirebaseEvent('Button_update_component_state');
                      _model.showTemplate = false;
                      safeSetState(() {});
                    } else {
                      logFirebaseEvent('Button_update_component_state');
                      _model.showTemplate = true;
                      safeSetState(() {});
                    }
                  },
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('EXAM_COMP_Row_227nkg2m_ON_TAP');
                      logFirebaseEvent('Row_copy_to_clipboard');
                      await Clipboard.setData(ClipboardData(
                          text: functions.newLine(
                              functions.newLine(widget.templateText!))));
                ...
                if (currentUserEmail == 'jamesjwalker01@gmail.com')
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('EXAM_COMP_UPDATE_BTN_ON_TAP');
                        logFirebaseEvent('Button_backend_call');

                        await widget.docreference!
                            .update(createExaminationsRecordData(
                          template: _model.textController.text,
                        ));
                      },
                      text: 'Update',
                      options: FFButtonOptions(
