...
class _CreateQuestionWidgetState extends State<CreateQuestionWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'create_question'});
              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'CREATE_QUESTION_arrow_back_rounded_ICN_O');
                              ...
                              children: [
                                if (responsiveVisibility(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_QUESTION_PAGE_desktopBack_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 4.0, 16.0, 0.0),
                                  child: Text(
                                    'Please fill out the information below in order to create your question and options for users.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                                          fontFamily:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'CREATE_QUESTION_PAGE_add_ICN_ON_TAP');
                                                logFirebaseEvent(
                                ...
                                if (_model.questionOptions.length >= 1)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 16.0, 16.0, 0.0),
                                    child: Text(
                                      'Select from the options below to add a correct answer.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily:
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, optionsIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CREATE_QUESTION_Container_kv8hw3uf_ON_TA');
                                              logFirebaseEvent(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CREATE_QUESTION_Icon_zwjh5ab8_ON_TAP');
                                                        logFirebaseEvent(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_QUESTION_ADD_QUESTION_BTN_ON_TAP');
                                  if (_model.correctAnswer != null &&
                                      _model.correctAnswer != '') {
                                    // createQuestion
                                    logFirebaseEvent('Button_createQuestion');
                                    ...
                                    await questionsRecordReference.set({
                                      ...createQuestionsRecordData(
                                        ...
                                        correctOption: _model.correctAnswer,
                                        explanation:
                                    ...
                                    context.pushNamed('create_question');
                                  } else {
